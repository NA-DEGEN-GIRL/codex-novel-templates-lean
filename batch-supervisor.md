...
2. Codex native MCP(`novel-editor`, `novel-calc`, `novel-hanja`, `novel-naming`)를 우선 사용한다.
...
- MCP 장애 시에만 `scripts/novel-calc`, `scripts/novel-hanja` fallback을 사용한다.
...
8. open HOLD의 `hold_route`와 만기 화수 지정 완료
9. `blocker=yes` HOLD 없음 또는 사용자 승인 확보
