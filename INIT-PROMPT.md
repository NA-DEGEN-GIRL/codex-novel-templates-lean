...
3. 프로젝트 생성
   ...
   - `summaries/` 초기 파일에서 placeholder와 작품 전용 규칙 누락을 점검한다
   - `scripts/run-codex-writer`, `scripts/run-codex-supervisor`, `scripts/run-codex-auditor`가 그대로 usable 한지 확인한다
