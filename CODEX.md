...
5. 날짜, 나이, 이동, 부상, 미해결 약속, 불변 조건이 중요하면 `settings/05-continuity.md`를 직접 확인한다.
...
2. `settings/01-style-guide.md`를 따르고, 대화와 관계 장면은 `settings/03-characters.md`의 운용 앵커를 기준으로 변주한다.
