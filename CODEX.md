...
15. 회상, 상대 시간 표현, 이동/회복/수련 기간, deadline이 있는 화는 초안 후 `settings/05-continuity.md`와 대조해 시간축 self-check를 수행한다. 애매하면 `novel-calc`의 날짜/기간 계산을 사용하거나 서술을 더 보수적으로 낮춘다.
